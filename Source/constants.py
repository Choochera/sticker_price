...
LTDM = 'LongTermDebtMaturitiesRepaymentsOfPrincipal'
LONG_TERM_DEBT_TTM = LTDM + 'InNextTwelveMonths'
LONG_TERM_DEBT_YEAR_TWO = LTDM + 'InYearTwo'
LONG_TERM_DEBT_YEAR_THREE = LTDM + 'InYearThree'
LONG_TERM_DEBT_YEAR_FOUR = LTDM + 'InYearFour'
LONG_TERM_DEBT_YEAR_FIVE = LTDM + 'InYearFive'
